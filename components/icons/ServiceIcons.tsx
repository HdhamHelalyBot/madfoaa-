...
export const TerminalIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 20H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h3"/><path d="M11 4h4a2 2 0 0 1 2 2v2"/><path d="M18 10h3a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-3"/><path d="m7 11 3.54 3.54a2 2 0 0 0 2.83 0L17 11"/><path d="M17 20v-4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v4"/></svg>
);
...
export const ServiceIcon = ({ index }: { index: number }) => {
    const icons = [
        <CreditCardIcon />,
        <TerminalIcon />,
        <LinkIcon />,
    ...
    return <div className="text-blue-800 dark:text-yellow-400 w-12 h-12 mb-4">{icons[index % icons.length]}</div>
}
